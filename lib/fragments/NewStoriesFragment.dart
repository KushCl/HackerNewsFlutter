...
class NewStoriesFragment extends StatefulWidget{

  @override
  State<StatefulWidget> createState() => new _NewStoriesFragmentState();

}

class _NewStoriesFragmentState extends State<NewStoriesFragment>{
  ...
  Future<void> _fetchNewestNews() async{
    ...
    final response = await http.get("https://api.hnpwa.com/v0/newest/$page.json");

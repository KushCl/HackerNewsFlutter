...
import 'package:hacker_news/models/TopStoriesDataItem.dart';
...
class TopStoriesFragment extends StatefulWidget {
  @override
  _TopStoriesState createState() => _TopStoriesState();
}

class _TopStoriesState extends State<TopStoriesFragment> {
  var isLoading = false;
  ...
  Future<void> _fetchData() async {
    ...
    final response = await http.get("https://api.hnpwa.com/v0/news/$page.json");
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: isLoading ? Center(child: CircularProgressIndicator()) : new RefreshIndicator(onRefresh: _fetchData,child: new ListView.builder(
